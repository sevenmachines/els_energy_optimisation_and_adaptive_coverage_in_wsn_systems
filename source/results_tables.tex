...
\caption{Results for average and cumulative CTV and energy values over each systems' lifetime. Cumulative values are from the comparison of the \acronymWSNOptimisation{}{} algorithm against \acronymQRouting{}{}. Percentage losses for both CTV and energy are from the end of the agent failure episode range of the \simulationNodeFailure{}{} system.}
