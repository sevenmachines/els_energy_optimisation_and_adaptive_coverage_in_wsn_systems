...
\begin{table}[ht]
	\centering
\begin{tabular}{
			|p{0.18\textwidth}|p{0.11\textwidth}|p{0.11\textwidth}|p{0.11\textwidth}|p{0.11\textwidth}|p{0.11\textwidth}|p{0.11\textwidth}|
		}
\hline
\textbf{Algorithm}
	& \textbf{CTV \newline (average)}
...
\begin{tabular}{
		|p{0.32\textwidth}|p{0.18\textwidth}|p{0.18\textwidth}|p{0.18\textwidth}|
	}
	\hline
	\textbf{Algorithm}
...
\end{tabular}
\captionsetup{labelfont=bf,singlelinecheck=on,justification=raggedright}
\caption{Effect of the CTV $\alpha,\beta,\gamma$ balance on quality-energy optimisation  and \newline distribution.}
