\begin{figure}[ht]
	\begin{minipage}{.49\textwidth}
		...
		\caption{Average CTV per-episode in the \simulationSimple{}{} system.}
	...
	\begin{minipage}{.49\textwidth}
		...
		\captionsetup{labelfont=bf,singlelinecheck=on}
		\caption{Cumulative CTV in the \simulationSimple{}{} system.}
...
\begin{figure}[ht]
	\begin{minipage}{.49\textwidth}
		...
		\captionsetup{labelfont=bf,singlelinecheck=on}
		\caption{Average CTV per-episode in the \newline \simulationExtended{}{} system.}
...
\begin{minipage}{.49\textwidth}
	...
	\captionsetup{labelfont=bf,singlelinecheck=on}
		\caption{Cumulative CTV in the \simulationExtended{}{}\newline system.}
