...
\end{minipage}
\end{figure}
\todo[inline]{START HERE}

\todo[inline]{CTV and energy optimisation better than q-routing}
...
\todo[inline]{Impact on CTV and energy is less in an-htao and recovers better}
...
\todo[inline]{CTV balance effects system optimisation behaviour}
