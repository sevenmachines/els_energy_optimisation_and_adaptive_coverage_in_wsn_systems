...
\begin{figure}[ht]
	...
	\begin{minipage}{.49\textwidth}
		\centering
		\includegraphics[width=1.0\linewidth,trim={25pt 0pt 50pt 0pt},clip]{7comparison_coverage-coverage-comparison}
		\captionsetup{labelfont=bf,singlelinecheck=on}
		\caption{7comparison coverage-coverage-comparison}
		\label{fig:7comparison_coverage-coverage-comparison}
	\end{minipage}\hfill% 
\end{figure}
\begin{figure}[ht]
	\begin{minipage}{.49\textwidth}
...
\begin{minipage}{.49\textwidth}
	\centering
	\includegraphics[width=1.0\linewidth,trim={25pt 0pt 50pt 0pt},clip]{7comparison_statistics-optimal-ctv-comparison}
	\captionsetup{labelfont=bf,singlelinecheck=on}
	\caption{7comparison statistics-optimal-ctv-comparison}
	\label{fig:7comparison_statistics-optimal-ctv-comparison}
\end{minipage}\hfill% 
\end{figure}
...
%	\begin{minipage}{.49\textwidth}
%		\centering
%		\includegraphics[width=1.0\linewidth,trim={25pt 0pt 50pt 0pt},clip]{520balanced_ctv-statistics-energy-available-gain}
%		\captionsetup{labelfont=bf,singlelinecheck=on}
%		\caption{Energy availability gain}
%		\label{fig:520balanced_ctv-statistics-energy-available-gain}
%	\end{minipage}
%\begin{minipage}{.49\textwidth}
%	\centering
