...
\example{Quality of a composite task}{
		...
		\end{enumerate}
	This means that, given relatively equivalent sensor quality measurements, the system will prefer to route the tasks through the agents with the most spare energy, but also network routes where the distribution of energy amongst participants is equal.
 }
