...
\todo[inline]{Whats wrong with centralised approaches?}
...
\todo[inline]{Whats wrong with decentralised approaches?}
...
\end{figure}
\todo[inline]{Whats wrong with learning approaches?}
...
The work we present tackles the optimisation of multiple, competing objectives in a WSN system. While also adapting network routes dynamically to not only optimise for energy, but also in response to task quality and network impacts.
