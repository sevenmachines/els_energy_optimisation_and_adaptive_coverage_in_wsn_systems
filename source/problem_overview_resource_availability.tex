...
Agents $\setAgent{}{} = \lbrace \varAgent{1}{}, \varAgent{2}{} \rbrace$ in a system each have a battery, an energy resource $\text{energy} \in \setResource{}{}$, with a capacity of $100$ units.  So $\functionAgentResources{1}{e} = 100$ and $\functionAgentResources{2}{e} = 100$.  Agent  $\varAgent{1}{}$  has used $50\%$ of its energy, $\functionAgentAvailableResources{1}{e} = 50$, while $\varAgent{2}{}$ has used $25\%$, $\functionAgentResources{2}{e} = 75s$. 
Therefore, 
$
\functionResourceAvailable{}{} 
= \frac{1}{2}
