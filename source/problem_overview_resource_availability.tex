...
Agents $\setAgent{}{} = \lbrace \varAgent{1}{}, \varAgent{2}{} \rbrace$ in a system each have a battery supplying energy with a capacity of $100$ units.  So $\functionAgentResources{1}{e} = 100$ and $\functionAgentResources{2}{e} = 100$.  Agent  $\varAgent{1}{}$  currently has $50\%$ of its energy available to use, $\functionAgentAvailableResources{1}{e} = 50$, while $\varAgent{2}{}$ has $25\%$, $\functionAgentResources{2}{e} = 75$. 
Therefore, 
$
\functionResourceAvailable{}{} 
= \frac{1}{2}
