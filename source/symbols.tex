...
\begin{table}[pos=htp]
	\begin{tabular}{|p{0.1\textwidth}|p{0.3\textwidth}|p{0.5\textwidth}|}
		...
		$\varSystemEnergyConsumption{}{}$ & System energy consumption& XXX \\
		$\varTaskEnergy{}{}$ & Task energy consumption & XXX \\
		$\varSystemEnergyVariability{}{}$ & System energy variability& XXX \\
		$\varAgentEnergyAvailable{}{}$ & Agent energy available & XXX \\
