...
and \ref{alg:wsn_optimisation_arc}, which are split for clarity. 


The flowchart in Figure \ref{fig:algorithm-flow} shows how agents in the system allocate atomic tasks, and choose actions, as part of a composite tasks' execution.
