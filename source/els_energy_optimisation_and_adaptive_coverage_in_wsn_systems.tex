...
\begin{document}
	...
	\section{Tasks, resources, and utility in a WSN system}
	\label{section:problem:introduction}					
	\input{problem}
	\input{problem_introduction}
	\input{problem_overview}
		\subsection{Properties of a WSN system}
	\label{section:problem:properties}						\input{problem_overview_nodes}
	...
	\label{section:problem:optimising_resource_usage}
	...
	\section{Measuring the robustness of a WSN}
